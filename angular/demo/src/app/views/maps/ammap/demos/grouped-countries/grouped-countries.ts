...
@Component({
    selector: 'demo-ammap-grouped-countries',
    templateUrl: './grouped-countries.html',
})
export class DemoAmMapGroupedCountriesComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        this.browserOnly(() => {
            ...
            // Create map instance
            let chart = am4core.create('groupedCountries', am4maps.MapChart);
