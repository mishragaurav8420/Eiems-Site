export const mailData = [
    ...
    },
    {
        ...
        date: "Jan 30",
        mail: "nathan@themenate.com",
        content: "<p>Hi Nathan,</p><p> I fully understand why it's former users left it for something else. They made a good decision. Be careful, or I will spill the beans on your placeholder text.</p><br /><p><strong class='text-dark'>Samantha Phillips</strong><br />Normal Crew</p>",
        checked : false,
        sent: 1,
        inbox: 0,
        deleted: 1,
