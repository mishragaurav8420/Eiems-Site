...
@Component({
    selector: 'demo-ammap-rotating-globe',
    templateUrl: './rotating-globe.html',
})
export class DemoAmMapRotatingGlobeComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        // Create map instance
            let chart = am4core.create('rotatingGlobe', am4maps.MapChart);
